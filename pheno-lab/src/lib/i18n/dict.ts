...
export const en = {
  ...
  "dash.needProject":
    "Pick a project (课题组) in settings before sending the experiment to the lab.",
  ...
  "set.project": "Project (课题组)",
  "set.projectNone": "— Not assigned —",
  "set.projectNew": "New project",
  "set.projectAdd": "Add",
  "set.projectHint":
    "Which research project this experiment belongs to. Required before it goes to the lab — it groups and filters the board, and never limits which experiments analysis may compare.",
  ...
  "proj.title": "Projects (课题组)",
  "proj.hint":
    "The research projects experiments are filed under. Managers curate this list; everyone picks from it. Deactivate a finished project to keep it out of the picker without touching its experiments.",
...
export const zh: Record<TKey, string> = {
  ...
  "dash.campaign": "专题",
  "dash.project": "课题组",
  "dash.allProjects": "全部课题组",
  "dash.noProject": "未指定课题组",
  "dash.needTitle":
    "送交实验室前请填写有意义的实验标题——「Untitled experiment」既无法检索，也无法生成报告。",
  "dash.needProject": "送交实验室前请在设置中选择所属课题组。",
  "dash.empty": "暂无内容。",
  "dash.open": "打开",
  ...
  "set.project": "课题组",
  "set.projectNone": "— 未指定 —",
  "set.projectNew": "新建课题组",
  "set.projectAdd": "添加",
  "set.projectHint":
    "本实验所属的课题组。送交实验室前必填——它用于看板归类和筛选，不会限制分析可比较的实验范围。",
  "set.campaign": "专题 / 实验组",
  "set.campaignHint":
  ...
  "proj.title": "课题组",
  "proj.hint":
    "实验所归属的课题组。由管理员维护列表，所有人从中选择。课题结束后可停用，它会从选择列表中隐藏，但不影响已有实验。",
  "proj.name": "课题组名称",
  "proj.add": "新增课题组",
