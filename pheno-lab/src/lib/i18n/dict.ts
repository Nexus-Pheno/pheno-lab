...
export const en = {
  ...
  "kiosk.add": "Register a tablet",
  "kiosk.labelPh": "e.g. Tablet 3 · A2-202 evaporation",
  "kiosk.create": "Register",
  "kiosk.addHint":
    "Copy the setup link and open it once in the tablet's browser — that pins this identity to that browser.",
...
export const zh: Record<TKey, string> = {
  ...
  "kiosk.create": "注册",
  "kiosk.addHint": "复制设置链接，在平板浏览器中打开一次，即可把该身份绑定到那台平板。",
  "kiosk.none": "尚未注册共享平板。",
